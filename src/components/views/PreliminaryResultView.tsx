...
const PreliminaryResultView: React.FC<PreliminaryResultViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-forest-gradient p-4 pt-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8 max-w-2xl mx-auto">
          <div className="bg-white rounded-xl p-4 shadow-md border border-gray-200">
            <div className="flex items-center justify-between">
              <span className="text-gray-600">{isUkrainian ? 'Магічна сила' : 'Magical Power'}</span>
              <span className="text-2xl font-bold text-wizard-primary">{lazinessScore}/10 🌲</span>
            </div>
          </div>
          <div className="bg-white rounded-xl p-4 shadow-md border border-gray-200">
            <div className="flex items-center justify-between">
              <span className="text-gray-600">{isUkrainian ? 'Якість промпту' : 'Prompt Quality'}</span>
              <span className="text-2xl font-bold text-wizard-accent">{qualityScore}/10 ⭐</span>
            </div>
          </div>
        </div>

        {/* Preliminary Prompt */}
        <div className="bg-white rounded-3xl shadow-xl p-8 border-2 border-wizard-forest-mist mb-8">
          <h3 className="text-xl font-bold text-wizard-enchanted-shadow mb-4 flex items-center">
          ...
          <div className="mt-4 flex justify-center">
            <button 
              ...
              className="flex items-center space-x-2 bg-wizard-primary text-white px-4 py-2 rounded-xl hover:bg-wizard-primary-dark transition-colors font-medium shadow-md"
            >
        ...
        {/* Choice Options */}
        <div className="bg-white rounded-3xl shadow-xl p-8 border-2 border-wizard-forest-mist">
          <h3 className="text-xl font-bold text-wizard-enchanted-shadow mb-2 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <button
              onClick={onFinish}
              className="p-6 rounded-xl border-2 transition-all hover:shadow-lg bg-wizard-forest-mist hover:bg-wizard-secondary-light border-wizard-primary text-wizard-primary-dark"
            >
              <div className="text-center">
                ...
                <span className="text-sm text-wizard-primary">
            ...
            {currentRound < 3 && (
              <button
                onClick={onContinue}
                className="p-6 rounded-xl border-2 transition-all hover:shadow-lg bg-wizard-secondary-light hover:bg-wizard-secondary border-wizard-accent text-wizard-accent-dark"
              >
                <div className="text-center">
                  <span className="text-3xl mb-2 block">🎯</span>
                  <span className="text-lg font-semibold block mb-1">
                  ...
                  <span className="text-sm text-wizard-accent">
