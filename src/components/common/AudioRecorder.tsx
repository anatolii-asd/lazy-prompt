      ...
      <AnimatePresence>
        ...
        {(isRecording || isProcessing) && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute bottom-0 left-0 right-0 h-14 bg-wizard-forest-mist border-2 border-wizard-primary rounded-b-2xl px-4 flex items-center justify-between"
          >
